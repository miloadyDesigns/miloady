...
const Testimonials = ({ gradient1, gradient2, name, stars, image, description, designation }) => {
    return (
        <div
            className='border border-slate-600 relative mx-2  xs:h-[450px] lg:h-[500px] rounded-lg  shadow-black px-4 lg:mx-2 '
            style={{
            ...
            <div className='w-auto xs:mt-12 lg:mt-20 text-white xs:text-[18px] lg:text-xl font-text font-bold '>
                ...
                <div className='mt-6'>
                    <ReactStars
                        ...
                        edit={false}
                    />
                    <h1 className='mt-4 ml-2 text-[32px] font-thin leading-none'>{name}, <span className='text-[22px]'>{designation}</span></h1>
                </div>
            </div>
        </div>
    );
