...
const Card = () => {
    return (
        // <div className='card'>
        //     <div className='icon'>
        //         <img className='w-[70px] h-[70px] mt-4' src="/about/mission-1.png" alt="" />
        //     </div>
        //     <div className='content'>
        //         <h2>Our Mission</h2>
        //         <p>Transforming bold ideas into stunning digital solutions that drive results and reflect your unique identity.</p>
        //     </div>
        // </div>
        <div class="gradient-cards">
            <div class="card">
                <div class="container-card bg-green-box">
                    ...
                    <p class="card-description">Transforming bold ideas into stunning digital solutions that drive results and reflect your unique identity.</p>
                </div>
            </div>
            <div class="card">
                <div class="container-card bg-white-box">
                    ...
                    <p class="card-description">Leading the digital landscape by inspiring brands to innovate through impactful and creative solutions.</p>
                </div>
            </div>
            ...
            <div class="card">
                <div class="container-card bg-yellow-box">
                    ...
                    <p class="card-title">Our Story</p>
                    <p class="card-description">Founded on creativity, Miloady Designs empowers businesses with design, and technology for success.</p>
                </div>
            </div>
